  ...
  if (isPending) {
    return (
      <div className="min-h-screen bg-[#0f0f13] flex flex-col items-center justify-center px-6">
        ...
        >
          <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center mb-8 shadow-2xl shadow-amber-500/30">
          ...
          <p className="text-zinc-400 text-center text-sm mb-6 leading-relaxed">
            Your account is being reviewed. An administrator must approve your email before you can access Bningoo ordering.
          </p>
          ...
          <p className="text-zinc-500 text-xs">
            Signed in as your Google account. You'll be able to order once approved.
          </p>
        </motion.div>
      </div>
    )
    ...
    <div className="min-h-screen bg-[#0f0f13] flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        <p className="text-zinc-400 text-center text-sm mb-10">
          Sign in to access Bningoo ordering
        </p>
